...
import { Plus, Edit2, Trash2, ArrowLeft, Star , Menu, X} from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs sm:text-sm text-gray-600">Manage customer testimonials</p>
            </div>
            <h1 className="sm:hidden text-lg font-bold text-gray-900">Testimonials</h1>
          </div>

          {/* Desktop Button */}
          <button
            onClick={() => setShowForm(!showForm)}
            className="hidden sm:flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-3 sm:px-4 py-2 rounded-lg font-semibold text-sm transition"
          >
            <Plus size={18} />
            {showForm ? 'Cancel' : 'Add'}
          </button>
        ...
        {menuOpen && (
          <div className="sm:hidden mt-2 pt-2 border-t border-gray-200">
            <button
              ...
              className="w-full flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-3 py-2 rounded-lg font-semibold text-sm transition"
            >
              <Plus size={16} />
